  ...
  (function (t) {
    ...
    function e(e) {
      return (
        ...
        (function (e, t) {
          for (
            var r = /^(\d+)\.(\d+)\.(\d+)/, n = r.exec(e) || [], o = r.exec(t) || [], a = 1;
            a <= 3;
            a++
          ) {
            if (+o[a] < +n[a]) return 1;
      ...
      function (e) {
        ...
        return (
          s.migrateIsPatchEnabled("selector-empty-id") &&
            "string" == typeof e &&
            "#" === e &&
            (u("selector-empty-id", "jQuery( '#' ) is not a valid selector"), (t[0] = [])),
          m.apply(this, t)
        );
      },
      "selector-empty-id"
    ...
    s.swap &&
      ...
      e("3.4.0") &&
        ...
        (s.cssProps = new Proxy(s.cssProps || {}, {
          set: function () {
            return (
              u("cssProps", "jQuery.cssProps is deprecated"), Reflect.set.apply(this, arguments)
            );
          },
        })),
      e("4.0.0")
          ...
          return e && "object" == typeof e && !Array.isArray(e)
            ...
            : ("number" == typeof t &&
                ...
                (C.test(n) && N.test(n[0].toUpperCase() + n.slice(1))) ||
                  ...
                  u(
                    "css-number",
                    'Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )'
                  )),
      ...
      function (e, t, r) {
        ...
        if (t && "object" == typeof t && 2 === arguments.length) {
          for (a in ((n = s.hasData(e) && E.call(this, e)), (o = {}), t))
            a !== x(a)
              ? (u("data-camelCase", "jQuery.data() always sets/gets camelCased names: " + a),
                (n[a] = t[a]))
              : (o[a] = t[a]);
        ...
        return t &&
          ...
          t in n
          ? (u("data-camelCase", "jQuery.data() always sets/gets camelCased names: " + t),
        ...
        function (e) {
          ...
          return (
            (r = (t = e).replace(F, "<$1></$2>")) !== t &&
              T(t) !== T(r) &&
              u("self-closed-tags", "HTML tags must be properly nested and closed: " + t),
            e.replace(F, "<$1></$2>")
          );
        },
        "self-closed-tags"
      ...
      i(
        ...
        function () {
          ...
          return !e || (e.nodeType && e.getBoundingClientRect)
            ...
            : (u("offset-valid-elem", "jQuery.fn.offset() requires a valid DOM element"),
                  ...
                  s.each(_, function (e, t) {
                    ...
                    a[t[1]](function () {
                      ...
                      e && "function" == typeof e.promise
                        ...
                        : n[t[0] + "With"](this === i ? n.promise() : this, r ? [e] : arguments);
                    });
                  }),
                    (o = null);
                })
