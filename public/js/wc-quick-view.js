  ...
  $("body").on("click", ".jupiterx-product-has-quick-view", function () {
    ...
    function addInputAndEvents() {
      ...
      if ($(".featherlight-content #" + id + " .custom-qty-input").length == 0) {
        ...
        $(".featherlight-content #" + id + " .input-text.qty").after(
        ...
        $(".featherlight-content #" + id + " .custom-qty-input .input-text.qty").val(
          $(".featherlight-content #" + id + " .input-text.qty").val()
        );
      }

      // Change quantity value on input change
      $(".featherlight-content .jupiterx-product-quick-view-modal").on(
        "keyup paste change",
      ...
      $(".featherlight-content #" + id).on("click", ".btn-increment", function () {
        $(".featherlight-content #" + id + " .custom-qty-input .input-text.qty")
