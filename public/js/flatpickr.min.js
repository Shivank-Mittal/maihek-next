...
!(function (e, n) {
  ...
  var t = [
    ...
    a = {
      ...
      getWeek: function (e) {
        ...
        return (
          1 + Math.round(((n.getTime() - t.getTime()) / 864e5 - 3 + ((t.getDay() + 6) % 7)) / 7)
        );
      },
      hourIncrement: 1,
  ...
  function k(p, v) {
    ...
    function k() {
      var e;
      return (
        (null === (e = w.calendarContainer) || void 0 === e ? void 0 : e.getRootNode())
    ...
    function O() {
      if (void 0 !== w.hourElement && void 0 !== w.minuteElement) {
        ...
        void 0 !== w.amPM &&
          ((e = t), (n = w.amPM.textContent), (t = (e % 12) + 12 * r(n === w.l10n.amPM[1])));
        var o =
    ...
    function De(e, n) {
      if (void 0 !== w.config) {
        ...
        "onChange" === e &&
          (w.input.dispatchEvent(we("change")), w.input.dispatchEvent(we("input")));
      }
    }
    function we(e) {
      ...
      (function () {
        (w.element = w.input = p),
                  ...
                  (function () {
                    ...
                    w.config.time_24hr ||
                      ((w.amPM = d(
                        ...
                        w.l10n.amPM[
                          r(
                            (w.latestSelectedDateObj ? w.hourElement.value : w.config.defaultHour) >
                              11
                          )
                        ]
                      )),
          ...
          (w.selectedDates.length || w.config.noCalendar) &&
            (w.config.enableTime && F(w.config.noCalendar ? w.latestSelectedDateObj : void 0),
            ye(!1)),
          S();
