function is_smooth_scroll() {
  return "undefined" == typeof jupiterxOptions || void 0 === jupiterxOptions.smoothScroll
    ? null
    : 0 != jupiterxOptions.smoothScroll;
}
(window.noZensmooth = !0),
  (function () {
    ...
    (this.Class = function () {}),
      (Class.extend = function (e) {
        ...
        for (var i in ((r = !1), e))
          t[i] =
            "function" == typeof e[i] && "function" == typeof n[i] && s.test(e[i])
              ? (function (i, o) {
                  return function () {
                    var e = this._super;
                    this._super = n[i];
        ...
        return (((o.prototype = t).constructor = o).extend = arguments.callee), o;
      });
  })(),
  (function (e, t, i) {
    "use strict";
    ...
    function o(e, t, i) {
      var o;
      for (o in e)
        if (Object.prototype.hasOwnProperty.call(e, o) && t && !1 === t.call(i, e[o], o, e)) return;
      return e;
    }
    function n(e, t, i) {
      for (
        var o, n, r = e._pubsub_topics, s = r[t] ? r[t].slice(0) : [], a = 0, l = s.length;
        a < l;
        a += 1
      )
        (n = s[a].token),
          (o = s[a]).callback(i, { name: t, token: n }),
    ...
    function s() {
      return this instanceof s
        ? ((this._pubsub_topics = {}), (this._pubsub_uid = -1), this)
        : new s();
    }
    var a = (t || {})[e];
    return (
      (s.prototype.subscribe = function (e, t, i) {
        ...
        return (
          o[e] || (o[e] = []), (r.token = n), (r.callback = t), (r.once = !!i), o[e].push(r), n
        );
      }),
      ...
      (s.prototype.unsubscribe = function (e) {
        var t,
          i,
          o = this._pubsub_topics,
          n = !1;
        for (t in o)
          if (Object.prototype.hasOwnProperty.call(o, t) && o[t]) {
            for (i = o[t].length; i; ) {
              if (((i -= 1), o[t][i].token === e))
                return o[t].splice(i, 1), 0 === o[t].length && delete o[t], e;
              t === e && (o[t].splice(i, 1), 0 === o[t].length && delete o[t], (n = !0));
            }
            if (!0 === n) return e;
          }
        return !1;
      ...
      (s.prototype.subscribers = function () {
        var i = {};
        return (
          o(this._pubsub_topics, function (e, t) {
            i[t] = e.slice(0);
          }),
          i
        );
  ...
  (function () {
    ...
    if (
      ...
      window.jQuery &&
        (((t = jQuery).fx.timer = function (e) {
          e() && t.timers.push(e) && !i && ((i = !0), s());
        }),
        (t.fx.stop = function () {
          i = !1;
        }));
    ...
    function s() {
      i && (requestAnimationFrame(s), t.fx.tick());
    }
  ...
  (function (e, t) {
    ...
    var e = a(),
      ...
      h = [];
    function a() {
      return "undefined" == typeof window ? {} : { x: window.innerWidth, y: window.pageYOffset };
    }
    function i(n) {
      requestAnimationFrame(function () {
        for (var e = a(), t = e.x, i = e.y, o = 0; o < h.length; o++)
          h[o]({ y: i, prevY: s, x: t, prevX: r }, n);
        (s = i), (r = t);
      });
    }
    return function (e) {
      ...
      return (
        (t = function (e, t) {
          var i = e.y,
            o = e.prevY;
          (c = t.timeStamp - p), (p = t.timeStamp);
          var n = (Math.abs(i - o) / c || 0) * l > a;
          if (o <= i && "down" !== d && n) {
            d = "down";
            for (var r = 0; r < f.length; r++) f[r]();
          } else if (i <= o && "up" !== d && n) {
            d = "up";
            for (var s = 0; s < u.length; s++) u[s]();
          }
        }),
    ...
    (s = function (e, t) {
      ...
      (s.prototype.buildRows = function () {
        var e,
          ...
          a = this;
        if (
          ((o = document.createDocumentFragment()), (r = a.$slider.children()), 1 < a.options.rows)
        ) {
          for (
            s = a.options.slidesPerRow * a.options.rows, n = Math.ceil(r.length / s), e = 0;
            e < n;
            e++
          ) {
            ...
            ? null !== r.activeBreakpoint
              ? (o === r.activeBreakpoint && !t) ||
                ...
                "unslick" === r.breakpointSettings[o]
                  ? r.unslick(o)
                  : ((r.options = d.extend({}, r.originalSettings, r.breakpointSettings[o])),
        ...
        if (
          (!0 === r.options.centerMode
            ...
            : ((i = r.options.infinite ? r.options.slidesToShow + r.currentSlide : r.currentSlide),
              ...
              !0 === r.options.fade && (0 < i && i--, o <= r.slideCount && o++)),
          (t = r.$slider.find(".slick-slide").slice(i, o)),
          "anticipated" === r.options.lazyLoad)
        )
          for (
            var n = i - 1, s = o, a = r.$slider.find(".slick-slide"), l = 0;
            l < r.options.slidesToScroll;
            l++
          )
            n < 0 && (n = r.slideCount - 1), (t = (t = t.add(a.eq(n))).add(a.eq(s))), n--, s++;
        e(t),
          r.slideCount <= r.options.slidesToShow
      ...
      (s.prototype.removeSlide = s.prototype.slickRemove =
        function (e, t, i) {
          ...
          if (
            ((e =
              "boolean" == typeof e ? (!0 === (t = e) ? 0 : o.slideCount - 1) : !0 === t ? --e : e),
        ...
        function () {
          ...
          if (
            ("object" === d.type(arguments[0])
              ? ((i = arguments[0]), (s = arguments[1]), (n = "multiple"))
            ...
            for (t in o)
              if ("array" !== d.type(r.options.responsive)) r.options.responsive = [o[t]];
              else {
      ...
      (s.prototype.swipeEnd = function (e) {
        ...
        if (
          ...
          "vertical" != i &&
            (o.slideHandler(t), (o.touchObject = {}), o.$slider.trigger("swipe", [o, i]));
        } else
            ...
            !a.options.verticalSwiping && !a.swiping && 4 < s
              ...
              : (!0 === a.options.verticalSwiping && (a.touchObject.swipeLength = s),
                ...
                !1 === a.options.vertical
                  ? (a.swipeLeft = t + o * n)
                  : (a.swipeLeft = t + o * (a.$list.height() / a.listWidth) * n),
  ...
  (function (p, u) {
    ...
    var v = "undefined" != typeof ShadowRoot,
        ...
        (e(i, [
          ...
          },
          {
            ...
            value: function () {
              this._active &&
                !this._removed &&
                (1 < Math.abs(g(this._clone.node) - this._clone.docOffsetTop) ||
          ...
          },
          {
            ...
            value: function () {
              ...
              this._deactivate(),
                s.some(function (e, t) {
                  if (e._node === i._node) return s.splice(t, 1), !0;
                }),
                (this._removed = !0);
            },
          },
      ...
      a = {
        ...
        addOne: function (e) {
          ...
          for (var t = 0; t < s.length; t++) if (s[t]._node === e) return s[t];
          return new n(e);
        },
        add: function (e) {
            ...
            for (var i = [], o = 0; o < e.length; o++)
              !(function () {
                ...
                t instanceof HTMLElement
                  ? s.some(function (e) {
                      if (e._node === t) return i.push(e), !0;
                    }) || i.push(new n(t))
                  : i.push(void 0);
              })();
            return i;
    ...
    m ||
      (function () {
        function e() {
          p.pageXOffset != r.left
            ? ((r.top = p.pageYOffset), (r.left = p.pageXOffset), a.refreshAll())
            : p.pageYOffset != r.top &&
              ((r.top = p.pageYOffset),
        ...
        "hidden" in u
          ...
          : "webkitHidden" in u && ((o = "webkitHidden"), (n = "webkitvisibilitychange")),
          n
            ? (u[o] || t(),
  ...
  (function () {
    ...
    if ("undefined" != typeof window) {
      ...
      var n = function (e, t, i) {
          var o, n, r, s, a;
          if (((i = i.split(" ")).length < 2 && (i[1] = i[0]), "x" === e))
            (o = i[0]), (n = i[1]), (r = "left"), (s = "right"), (a = t.clientWidth);
          else {
            if ("y" !== e) return;
            (o = i[1]), (n = i[0]), (r = "top"), (s = "bottom"), (a = t.clientHeight);
          }
          return o === r || n === r
            ? void (t.style[r] = "0")
            : o === s || n === s
              ? void (t.style[s] = "0")
              : "center" === o || "50%" === o
                ? ((t.style[r] = "50%"), void (t.style["margin-" + r] = a / -2 + "px"))
                : 0 <= o.indexOf("%")
                  ? void ((o = parseInt(o)) < 50
                      ? ((t.style[r] = o + "%"), (t.style["margin-" + r] = a * (o / -100) + "px"))
                      : ((o = 100 - o),
                        (t.style[s] = o + "%"),
                        (t.style["margin-" + s] = a * (o / -100) + "px")))
                  : void (t.style[r] = o);
        },
        r = function (e) {
          ...
          (function (e) {
            ...
            (function (e) {
              ...
              for (var o in i) t.getPropertyValue(o) !== i[o] && (e.style[o] = i[o]);
            })(e),
            ...
            "scale-down" === t &&
              ((e.style.height = "auto"),
              e.clientWidth < o.clientWidth && e.clientHeight < o.clientHeight
                ? (n("x", e, i), n("y", e, i))
                : ((t = "contain"), (e.style.height = "100%"))),
            "none" === t
              ? ((e.style.width = "auto"), (e.style.height = "auto"), n("x", e, i), n("y", e, i))
              : ("cover" === t && e.clientWidth > o.clientWidth) ||
                  ("contain" === t && e.clientWidth < o.clientWidth)
                ? ((e.style.top = "0"), (e.style.marginTop = "0"), n("x", e, i))
                : "scale-down" !== t &&
                  ((e.style.width = "100%"),
                  (e.style.height = "auto"),
                  (e.style.left = "0"),
    ...
    if (!1 !== is_smooth_scroll()) {
      var g = function (e) {
        return (
          ...
          "smooth" === window.getComputedStyle(e)["scroll-behavior"]
        );
      };
      ...
      var o = function (l, i, d) {
          ...
          function f(e, o, n) {
            if ((p(), 0 === o || (o && o < 0) || g(l.body))) l.toY(e), n && n();
            else {
              var r = l.getY(),
                s = Math.max(0, e) - r,
                a = new Date().getTime();
                  ...
                  c(
                    setTimeout(function () {
                      var e = Math.min(1, (new Date().getTime() - a) / o),
                        t = Math.max(
                          0,
                          Math.floor(r + s * (e < 0.5 ? 2 * e * e : e * (4 - 2 * e) - 1))
                        );
                      l.toY(t),
                        e < 1 && l.getHeight() + t < l.body.scrollHeight
                          ? i()
                          : (setTimeout(p, 99), n && n());
                    }, 9)
                  );
          ...
          return {
            setup: function (e, t) {
              return (
                (0 !== e && !e) || (i = e),
                (0 !== t && !t) || (d = t),
                { defaultDuration: i, edgeOffset: d }
              );
            },
            to: h,
            toY: f,
            ...
            center: function (e, t, i, o) {
              f(
                Math.max(
                  0,
                  l.getTopOf(e) - l.getHeight() / 2 + (i || e.getBoundingClientRect().height / 2)
                ),
                t,
                o
              );
      ...
      if (
        ((l.createScroller = function (t, e, i) {
          return o(
            {
              body: t,
              toY: function (e) {
...
var jupiterx = { components: {}, utils: {} };
(jupiterx.components.Base = Class.extend({
  setElements: function () {
    this.elements = {};
    var e = jQuery;
    (this.elements.window = window),
      (this.elements.$window = e(window)),
      (this.elements.$document = e(document)),
      (this.elements.$body = e("body")),
      (this.elements.$site = e(".jupiterx-site"));
  },
  setSettings: function () {
    (this.settings = {}), (this.settings.windowWidth = this.elements.$window.outerWidth());
  },
  bindEvents: function () {},
  init: function () {
    this.setElements(), this.setSettings(), this.bindEvents();
  },
})),
      ...
      (this.resize = function () {
        ...
        (this.scroll = function () {
          var t = e.pubsub,
            ...
            o = _.defaults(i.data("jupiterxScroll") || {}, { offset: 1e3 });
          r(window).on(
            "scroll",
            _.throttle(function () {
              var e = r(this).scrollTop();
              if ((t.publish("scroll", e), !(_.size(i) < 1)))
                return e > o.offset
                  ? i.addClass("jupiterx-scrolled")
                  : void i.removeClass("jupiterx-scrolled");
            }, 100)
          );
        }),
        (this.scrollSmooth = function () {
          r(document).on("click", "[data-jupiterx-scroll-target]", function (e) {
            ...
            e.preventDefault(),
              ...
              _.isNumber(t)
                ? window.scrollTo({ top: t, left: 0, behavior: i })
                : window.scrollTo({ top: r(t).offset().top, left: 0, behavior: i });
          });
        }),
        (this.scrollDirection = function () {
          ...
          i.up(function () {
            e.publish("scroll-up"),
              _.size(t) < 1 ||
                (t.addClass("jupiterx-scroll-up"), t.removeClass("jupiterx-scroll-down"));
          }),
            i.down(function () {
              e.publish("scroll-down"),
                _.size(t) < 1 ||
                  (t.addClass("jupiterx-scroll-down"), t.removeClass("jupiterx-scroll-up"));
            });
        }),
        (this.alterClass = function (e, t, i) {
          var o = e;
          if (-1 === t.indexOf("*")) return o.removeClass(t), i ? o.addClass(i) : o;
          var n = new RegExp(
            "\\s" + t.replace(/\*/g, "[A-Za-z0-9-_]+").split(" ").join("\\s|\\s") + "\\s",
            "g"
          );
          return (
            o.each(function (e, t) {
              for (var i = " " + t.className + " "; n.test(i); ) i = i.replace(n, " ");
        ...
        (this.init = function () {
          this.resize(), this.scroll(), this.scrollSmooth();
        }),
        this.init();
    };
  })(jQuery),
  (function (a) {
    ...
    e.components.Header = e.components.Base.extend({
      ...
      bindEvents: function () {
        ...
        t.focusToggler(),
          ...
          i.$dropdownToggler.on("click", function (e) {
            t.initNavbarDropdown(e), t.setHeight();
          }),
          ...
          a(document).on(
            "click",
            "a.jupiterx-smooth-scroll, .jupiterx-smooth-scroll a",
            function (e) {
      ...
      lastItemDepth: function (e, t) {
        var i = e;
        if ((($li = t.find("> li:last-child")), $li.hasClass("dropdown")))
        ...
        for (var t = [], i = 0; i < e.find("> li").length; i++)
          ($li = e.find("> li:nth-of-type(" + (i + 1) + ")")),
            $li.hasClass("dropdown")
              ? (t[i] = this.lastItemDepth(1, $li.find(".dropdown-menu")))
              : (t[i] = 1);
        return t;
      },
      focusToggler: function () {
        a(".jupiterx-site-navbar")
          .find("a")
          .on("focus", function () {
      ...
      blurToggler: function () {
        var n = this;
        a(".jupiterx-nav-primary")
          .find("a")
          .on("blur", function () {
            for (
              var e = a(this), t = n.lastItemDepths(a(".jupiterx-nav-primary")), i = 0, o = !0;
              !e.hasClass("jupiterx-nav-primary");

            )
              "li" === e.prop("tagName").toLowerCase() &&
                ((o = o && -1 === e.next().index()),
                i++,
                e.parent().hasClass("jupiterx-nav-primary") &&
                  i === t[e.index()] &&
                  o &&
                  a(".dropdown.hover, ul.dropdown-menu.hover").removeClass("hover show")),
                (e = e.parent());
      ...
      mobileMenuScroll: function () {
        for (
          var i = document.getElementsByClassName("navbar-collapse"), o = null, n = 0;
          n < i.length;
          n++
        )
      ...
      setBehavior: function () {
        this.setBehaviorFixed(), this.setBehaviorSticky();
      },
      ...
      setBehaviorSticky: function (e) {
        var t = this.elements,
          i = this.settings;
        if (
          !(0 < t.$body.find(".jupiterx-header").find(".raven-sticky").length) &&
          "sticky" === i.behavior &&
          void 0 !== e
        ) {
          if (e > i.headerHeight) {
            t.$body.addClass("jupiterx-header-stick"), this.setSiteSpacing();
            var o = a(
          ...
          e > i.offset
            ? t.$body.addClass("jupiterx-header-sticked")
            : t.$body.removeClass("jupiterx-header-sticked");
        }
      },
      setSiteSpacing: function () {
        var e = this.elements,
          t = this.settings;
        if (this.isOverlap()) {
          if ((this.clearSiteSpacing(), "fixed" === t.behavior && 0 < a(".jupiterx-tbar").length)) {
            var i = window.jupiterx.utils.onMobile() ? "" : this.tbarHeight() || "";
            (i -= this.getJetScrollNavSectionOffset()), e.$site.css("padding-top", i);
          }
        } else {
          var o = e.$header;
          if ("fixed" === t.behavior && "bottom" === t.position)
            ...
            var n = 0,
              r = a(
                ".jupiterx-header.jupiterx-header-sticky-custom.jupiterx-header-custom > .elementor:first-of-type:not(:last-of-type)"
              );
      ...
      getJetScrollNavSectionOffset: function () {
        if ((($jetScroll = a(".jet-scroll-navigation")), 0 === $jetScroll.length)) return 0;
      ...
      initNavbarDropdown: function (e) {
        if (
          ...
          return a(e.target).closest(".menu-item").hasClass("focus")
            ? (a(e.target).closest(".menu-item").removeClass("focus"),
              void a(e.target).closest(".menu-item").find("> .dropdown-menu").removeClass("focus"))
            : void a(e.target).closest(".menu-item").find("> .dropdown-menu").toggleClass("show");
      },
      inPageMenuClick: function () {
        ...
        this.elements.$navbar.on("click", function (e) {
          ...
          if (
            ...
            (n = t.hash), e.preventDefault();
            var i = a(n);
            if (0 === i.length)
              return (
                a("#jupiterxSiteNavbar").hasClass("show") &&
                  r.isBelowDesktop() &&
                  a("#jupiterxSiteNavbar").collapse("hide"),
                void window.history.pushState(null, null, t.hash)
              );
            var o = i.offset().top;
            if (
              ((o -= r.getAdminbarHeight()),
              (o -= r.getBodyBorderWidth()),
              s && "sticky" === s.behavior && s.overlap
                ? (o -= r.isHeaderSticked() ? r.tbarHeight() : 2 * r.tbarHeight())
                : s && !s.behavior
                  ? (o -= r.isHeaderSticked() ? r.tbarHeight() : 2 * r.tbarHeight())
                  : (o -= r.tbarHeight()),
            ...
            window.scroll({ top: o, behavior: "auto" });
          }
        });
      },
      inPageMenuScroll: function () {
        var e = this;
        e.elements.$inPageMenuItems.length &&
          (e.activateMenuItem(),
          window.addEventListener(
            "scroll",
            _.throttle(function () {
      ...
      activateMenuItem: function () {
        ...
        n.elements.$inPageMenuItems.each(function (e, t) {
          return (
            t.hash < 1 ||
            !(o = document.querySelector('[id="' + t.hash.replace("#", "") + '"]')) ||
            (Math.abs(a(o).offset().top + a(o).outerHeight() - a(document).height()) < 10 &&
            Math.abs(a(window).scrollTop() + window.innerHeight - a(document).height()) < 10
              ? ((i = t.hash), !1)
              : r + 10 >= a(o).offset().top - n.getHeaderHeight() - n.getAdminbarHeight()
                ? ((i = t.hash), !0)
                : void 0)
          );
        }),
      ...
      hasCustomStickyHeader: function () {
        if (0 === a(".jupiterx-header.jupiterx-header-custom").length) return !1;
      ...
      handlePageLoadScroll: function () {
        ...
        a(document).ready(function () {
          if (
            !(
              (window.jupiterx.utils.onMobile() &&
                a("body").hasClass("jupiterx-header-mobile-behavior-off")) ||
              (window.jupiterx.utils.onTablet() &&
                a("body").hasClass("jupiterx-header-tablet-behavior-off"))
            )
          ) {
            ...
            if (0 !== e.length) {
              ...
              (t -= i.getAdminbarHeight()),
                ...
                o && "sticky" === o.behavior && o.overlap
                  ? (t -= i.isHeaderSticked() ? i.tbarHeight() : 2 * i.tbarHeight())
                  : o && !o.behavior
                    ? (t -= i.isTbarFixed() ? i.tbarHeight() : 2 * i.tbarHeight())
                    : (t -= i.tbarHeight()),
                i.hasCustomStickyHeader()
                  ? (t -= i.getCustomStickyHeaderHeight())
                  : ((o && "fixed" === o.behavior && "top" === o.position) ||
                      (o && "sticky" === o.behavior)) &&
                    (t -= i.getHeaderHeight()),
                a("#jupiterxSiteNavbar")
                  .find("a")
                  .each(function (e, t) {
                    window.location.hash == "#" + a(t).attr("href").split("#")[1] &&
                      (a(t).addClass("active"), a(t).parent().addClass("active"));
                  }),
                !1 !== is_smooth_scroll()
                  ? a("html, body").stop().animate({ scrollTop: t }, 500, "swing")
                  : window.scroll({ top: t, behavior: "auto" });
            }
          }
        });
      },
      handleSmoothScrollElements: function (e, t) {
        ...
        if (
          (r.href.replace(r.hash, "") === window.location.href.replace(window.location.hash, "") ||
            -1 !== n.search(/^#/)) &&
          -1 !== r.hash.search(/^#/)
        ) {
          (n = r.hash), e.preventDefault();
          var s = a(n).offset().top;
          return (
            (s -= i.getAdminbarHeight()),
            (s -= i.getBodyBorderWidth()),
            o && "sticky" === o.behavior && o.overlap
              ? (s -= i.isHeaderSticked() ? i.tbarHeight() : 2 * i.tbarHeight())
              : o && !o.behavior
                ? (s -= i.isHeaderSticked() ? i.tbarHeight() : 2 * i.tbarHeight())
                : (s -= i.tbarHeight()),
            i.hasCustomStickyHeader()
              ? (s -= i.getCustomStickyHeaderHeight())
              : ((o && "fixed" === o.behavior && "top" === o.position) ||
                  (o && "sticky" === o.behavior)) &&
                (s -= i.getHeaderHeight()),
            ...
            a("html, body")
              .stop()
              .animate({ scrollTop: s }, 500, "swing", function () {
  ...
  jQuery(document).ready(function (n) {
    n(".jupiterx-footer-fixed").each(function (e, t) {
      var i,
        o = n(t);
      (i = n("<span></span>", { class: "jupiterx-footer-dummy" })),
        o.after(i),
      ...
      n("body").is(".elementor-editor-active.jupiterx-header-overlapped") &&
        n("header.jupiterx-header").length &&
        (n("body").prepend(
          '<div class="jupiterx-toggle-overlapped"><i class="jupiterx-icon-eye-slash" ></i><span>Hide Header</span></div>'
        ),
        ...
        n(".jupiterx-toggle-overlapped").on("click", function () {
          ...
          n(".jupiterx-header-overlapped header").toggle(),
            t.hasClass("jupiterx-icon-eye-slash")
              ? (e.text("Show Header"),
                t.removeClass("jupiterx-icon-eye-slash").addClass("jupiterx-icon-eye-regular"))
              : (e.text("Hide Header"),
  ...
  jQuery(document).ready(function () {
    ...
    (e.initComponents = function () {
      for (component in this.components) new this.components[component]();
    }),
      (e.init = function () {
...
!(function (e, t) {
  ...
  function w(e) {
    ...
    for (
      var t = m(10) ? document.body : null, i = e.offsetParent;
    ...
    return o && "BODY" !== o && "HTML" !== o
      ? -1 !== ["TD", "TABLE"].indexOf(i.nodeName) && "static" === b(i, "position")
        ? w(i)
        : i
      : e
  ...
  function v(e, t) {
    var i =
        "top" === (1 < arguments.length && void 0 !== t ? t : "top") ? "scrollTop" : "scrollLeft",
      o = e.nodeName;
    if ("BODY" !== o && "HTML" !== o) return e[i];
  ...
  function C(e) {
    ...
    if (l || d) {
      var c = b(e);
      (l -= p(c, "x")), (d -= p(c, "y")), (n.width -= l), (n.height -= d);
    }
    return T(n);
  }
  function S(e, t, i) {
    ...
    o && "HTML" === t.nodeName && ((a.top = Math.max(a.top, 0)), (a.left = Math.max(a.left, 0)));
    var u = T({
      top: s.top - a.top - c,
    ...
    return (
      (n && !o ? t.contains(l) : t === l && "BODY" !== l.nodeName) &&
        (u = (function (e, t, i) {
          var o = 2 < arguments.length && void 0 !== i && i,
            n = v(t, "top"),
            r = v(t, "left"),
  ...
  function $(e, t, i, o, n) {
    ...
    if ("viewport" === o)
      ...
      var l = void 0;
      "scrollParent" === o
        ? "BODY" === (l = g(f(t))).nodeName && (l = e.ownerDocument.documentElement)
        : (l = "window" === o ? e.ownerDocument.documentElement : o);
      var d = S(l, a, r);
      if (
        "HTML" !== l.nodeName ||
        (function e(t) {
  ...
  function H(e, t, i) {
    ...
    var o = E(e),
      ...
      l = r ? "height" : "width",
      d = r ? "width" : "height";
    return (n[s] = t[s] + t[l] / 2 - o[l] / 2), (n[a] = i === a ? t[a] - o[d] : t[A(a)]), n;
  }
  function P(e, t) {
  ...
  function L(e) {
    for (
      var t = [!1, "ms", "Webkit", "Moz", "O"], i = e.charAt(0).toUpperCase() + e.slice(1), o = 0;
      o < t.length;
      o++
    ) {
      var n = t[o],
  ...
  function N(e, t, i, o) {
    (i.updateBound = o), I(e).addEventListener("resize", i.updateBound, { passive: !0 });
    var n = g(e);
    return (
      (function e(t, i, o, n) {
        var r = "BODY" === t.nodeName,
          s = r ? t.ownerDocument.defaultView : t;
        s.addEventListener(i, o, { passive: !0 }), r || e(g(s.parentNode), i, o, n), n.push(s);
  ...
  function X(e, n, r, t) {
    ...
    var l = /\s*,\s*|\s+/,
      d =
        -1 !== o
          ? [i.slice(0, o).concat([i[o].split(l)[0]]), [i[o].split(l)[1]].concat(i.slice(o + 1))]
          : [i];
    return (
      ...
      modifiers: {
        ...
        preventOverflow: {
          ...
          fn: function (e, o) {
            ...
            (n.top = r), (n.left = s), (n[i] = a), (o.boundaries = l);
            var d = o.priority,
              c = e.offsets.popper,
              p = {
                primary: function (e) {
                  var t = c[e];
                  return (
                    c[e] < l[e] && !o.escapeWithReference && (t = Math.max(c[e], l[e])), k({}, e, t)
                  );
                },
                secondary: function (e) {
                  ...
                  return (
                    c[e] > l[e] &&
                      ...
                      (i = Math.min(c[t], l[e] - ("right" === e ? c.width : c.height))),
                    k({}, t, i)
                  );
                },
              };
        ...
        keepTogether: {
          ...
          fn: function (e) {
            var t = e.offsets,
              ...
              d = s ? "width" : "height";
            return (
              i[a] < r(o[l]) && (e.offsets.popper[l] = r(o[l]) - i[d]),
        ...
        arrow: {
          ...
          fn: function (e, t) {
            ...
            return (
              (y = Math.max(Math.min(s[d] - h, y), 0)),
              (e.arrowElement = o),
              (e.offsets.arrow = (k((i = {}), p, Math.round(y)), k(i, u, ""), i)),
              e
            );
          },
          element: "[x-arrow]",
          ...
          fn: function (f, h) {
            ...
            return (
              y.forEach(function (e, t) {
                if (m !== e || y.length === t + 1) return f;
                (m = f.placement.split("-")[0]), (v = A(m));
                var i = f.offsets.popper,
                  o = f.offsets.reference,
                  n = Math.floor,
                  r =
                    ("left" === m && n(i.right) > n(o.left)) ||
                    ("right" === m && n(i.left) < n(o.right)) ||
                    ("top" === m && n(i.bottom) > n(o.top)) ||
                    ("bottom" === m && n(i.top) < n(o.bottom)),
                  s = n(i.left) < n(g.left),
                ...
                (r || c || u) &&
                  ...
                  (f.offsets.popper = x(
                    {},
                    f.offsets.popper,
                    H(f.instance.popper, f.offsets.reference, f.placement)
                  )),
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            var s = void 0 !== r ? r : t.gpuAcceleration,
              ...
              h = void 0;
            if (
              ((h = "bottom" == c ? -a.height + d.bottom : d.top),
              ...
              var g = "bottom" == c ? -1 : 1,
                m = "right" == p ? -1 : 1;
              (l[c] = h * g), (l[p] = f * m), (l.willChange = c + ", " + p);
            }
            var v = { "x-placement": e.placement };
            return (
              (e.attributes = x({}, v, e.attributes)),
        ...
        applyStyle: {
          ...
          onLoad: function (e, t, i, o, n) {
            ...
            return (
              ...
              W(t, { position: i.positionFixed ? "fixed" : "absolute" }),
              i
            );
          },
      ...
      (c(Z, [
        ...
        },
        {
          ...
          value: function () {
            return function () {
              this.state.eventsEnabled ||
                (this.state = N(this.reference, this.options, this.state, this.scheduleUpdate));
            }.call(this);
          },
        },
        {
  ...
  return (
    (G.Utils = ("undefined" != typeof window ? window : global).PopperUtils),
    (G.placements = q),
    (G.Defaults = K),
    G
  );
...
var Dropdown = (function (d) {
  var t = "dropdown",
    ...
    C = "right-start",
    S = "left-start",
    _ = { offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic" },
    $ = {
    ...
    j = (function () {
      ...
      return (
          ...
          if (!this._element.disabled && !d(this._element).hasClass(a)) {
            ...
            if ((l._clearMenus(), !t)) {
              var i = { relatedTarget: this._element },
                o = d.Event(p.SHOW, i);
              if ((d(e).trigger(o), !o.isDefaultPrevented())) {
                if (!this._inNavbar) {
                  ...
                  "parent" === this._config.reference
                    ? (n = e)
                    : Util.isElement(this._config.reference) &&
                ...
                "ontouchstart" in document.documentElement &&
                  0 === d(e).closest(w).length &&
                  d(document.body).children().on("mouseover", null, d.noop),
                  this._element.focus(),
        ...
        (e._getConfig = function (e) {
          return (
            (e = _objectSpread({}, this.constructor.Default, d(this._element).data(), e)),
        ...
        (e._getPlacement = function () {
          ...
          return (
            e.hasClass(n)
              ? ((t = b), d(this._menu).hasClass(h) && (t = k))
              : e.hasClass(r)
                ? (t = C)
                : e.hasClass(f)
                  ? (t = S)
                  : d(this._menu).hasClass(h) && (t = T),
            t
          );
        }),
        ...
        (e._getPopperConfig = function () {
          ...
          "function" == typeof this._config.offset
            ? (e.fn = function (e) {
                return (
                  (e.offsets = _objectSpread({}, e.offsets, t._config.offset(e.offsets) || {})), e
                );
              })
        ...
        (l._jQueryInterface = function (t) {
          return this.each(function () {
            var e = d(this).data(c);
            if (
              (e || ((e = new l(this, "object" == typeof t ? t : null)), d(this).data(c, e)),
              "string" == typeof t)
            ) {
                ...
                if (
                  ...
                  d(o).trigger(a),
                    a.isDefaultPrevented() ||
                      ("ontouchstart" in document.documentElement &&
                        d(document.body).children().off("mouseover", null, d.noop),
          ...
          if (
            (/input|textarea/i.test(e.target.tagName)
              ? !(
                  32 === e.which ||
                  (27 !== e.which &&
                    ((40 !== e.which && 38 !== e.which) || d(e.target).closest(v).length))
                )
              : s.test(e.which)) &&
  ...
  return (
    ...
    (d.fn[t].noConflict = function () {
      return (d.fn[t] = o), j._jQueryInterface;
    }),
    j
  );
})($, Popper);
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : ((e = "undefined" != typeof globalThis ? globalThis : e || self).Collapse = t(
          e.jQuery,
          e.Util
        ));
})(this, function (e, t) {
      ...
      return (
        ...
        (e.show = function () {
          ...
          if (
            ...
            !l.default(this._element).hasClass(p) &&
            (this._parent &&
              0 ===
                (e = [].slice
            ...
            if ((l.default(this._element).trigger(o), !o.isDefaultPrevented())) {
              e &&
                (a._jQueryInterface.call(l.default(e).not(this._selector), "hide"),
                t || l.default(e).data(c, null));
              var n = this._getDimension();
              l.default(this._element).removeClass(u).addClass(f),
                (this._element.style[n] = 0),
                this._triggerArray.length &&
                  l.default(this._triggerArray).removeClass(h).attr("aria-expanded", !0),
                this.setTransitioning(!0);
              var r = "scroll" + (n[0].toUpperCase() + n.slice(1)),
                s = d.default.getTransitionDurationFromElement(this._element);
              l
                .default(this._element)
                .one(d.default.TRANSITION_END, function () {
                  l
                    .default(i._element)
                    .removeClass(f)
                    .addClass(u + " " + p),
        ...
        (e.hide = function () {
          ...
          if (!this._isTransitioning && l.default(this._element).hasClass(p)) {
            ...
            if ((l.default(this._element).trigger(t), !t.isDefaultPrevented())) {
              ...
              if (0 < o)
                for (var n = 0; n < o; n++) {
                  var r = this._triggerArray[n],
                    s = d.default.getSelectorFromElement(r);
                  if (null !== s)
                    l.default([].slice.call(document.querySelectorAll(s))).hasClass(p) ||
                      l.default(r).addClass(h).attr("aria-expanded", !1);
                }
              this.setTransitioning(!0);
              this._element.style[i] = "";
              var a = d.default.getTransitionDurationFromElement(this._element);
              l.default(this._element)
                .one(d.default.TRANSITION_END, function () {
        ...
        (e._getConfig = function (e) {
          return (
            ((e = n({}, m, e)).toggle = Boolean(e.toggle)), d.default.typeCheckConfig(r, e, v), e
          );
        }),
        ...
        (e._getParent = function () {
          var e,
            i = this;
          d.default.isElement(this._config.parent)
            ? ((e = this._config.parent),
              void 0 !== this._config.parent.jquery && (e = this._config.parent[0]))
            : (e = document.querySelector(this._config.parent));
          var t = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]',
            o = [].slice.call(e.querySelectorAll(t));
          return (
            l.default(o).each(function (e, t) {
        ...
        (a._jQueryInterface = function (o) {
          return this.each(function () {
            ...
            if (
              (!t && i.toggle && "string" == typeof o && /show|hide/.test(o) && (i.toggle = !1),
              t || ((t = new a(this, i)), e.data(c, t)),
              "string" == typeof o)
            ) {
  ...
  return (
    l.default(document).on("click.bs.collapse.data-api", g, function (e) {
    ...
    (l.default.fn[r].noConflict = function () {
      return (l.default.fn[r] = s), a._jQueryInterface;
    }),
    a
  );
}),
  (function (c) {
    ...
    if (void 0 !== c)
      if (c.fn.jquery.match(/-ajax/))
        ...
        (l.prototype = {
          ...
          setup: function (e, t) {
            "object" != typeof e || e instanceof c != !1 || t || ((t = e), (e = void 0));
            var i = c.extend(this, t, { target: e }),
              o = i.resetCss ? i.namespace + "-reset" : i.namespace,
              n = c(
                i.background ||
                  [
                    '<div class="' + o + "-loading " + o + '">',
                    '<div class="' + o + '-content">',
                    '<button class="' +
                      o +
                      "-close-icon " +
                    ...
                    i.closeIcon,
                    "</button>",
                    '<div class="' + i.namespace + '-inner">' + i.loading + "</div>",
                    "</div>",
                    "</div>",
                  ].join("")
              ),
            ...
            return (
              (i.$instance = n.clone().addClass(i.variant)),
              i.$instance.on(i.closeTrigger + "." + i.namespace, function (e) {
                if (!e.isDefaultPrevented()) {
                  var t = c(e.target);
                  (("background" === i.closeOnClick && t.is("." + i.namespace)) ||
          ...
          getContent: function () {
            ...
            var t = this,
              ...
              n = t.target || o || "",
              r = i[t.type];
            if ((!r && n in i && ((r = i[n]), (n = t.target && o)), (n = n || e("href") || ""), !r))
              for (var s in i) t[s] && ((r = i[s]), (n = t[s]));
            if (!r) {
              var a = n;
              if (
                ((n = null),
          ...
          c.extend(l, {
            ...
            contentFilters: {
              ...
              image: {
                ...
                process: function (e) {
                  var t = c.Deferred(),
                    i = new Image(),
                    o = c('<img src="' + e + '" alt="" class="' + this.namespace + '-image" />');
                  return (
                    (i.onload = function () {
                      (o.naturalWidth = i.width), (o.naturalHeight = i.height), t.resolve(o);
                    }),
                    (i.onerror = function () {
                      t.reject(o);
                    }),
              ...
              ajax: {
                ...
                process: function (e) {
                  var i = c.Deferred(),
                    o = c("<div></div>").load(e, function (e, t) {
                ...
                process: function (e) {
                  var t = new c.Deferred(),
                    ...
                    o = (function (e, t) {
                      ...
                      for (var n in e) {
                        var r = n.match(o);
                        if (r) i[(r[1] + r[2].replace(/([A-Z])/g, "-$1")).toLowerCase()] = e[n];
                      }
                      return i;
                    })(this, "iframe"),
                    n = (function (e, t) {
                      var i = {};
                      for (var o in e) o in t && ((i[o] = e[o]), delete e[o]);
                      return i;
                    })(o, r);
                  return (
                    i
                ...
                e &&
                  ...
                  c.each(e.attributes, function () {
                    ...
                    if (e) {
                      var t = this.value,
                        i = c.camelCase(e[1]);
                      if (0 <= c.inArray(i, o.functionAttributes)) t = new Function(t);
                      else
                        try {
                          t = JSON.parse(t);
                        } catch (e) {}
            ...
            attach: function (n, r, s) {
              var a = this;
              "object" != typeof r || r instanceof c != !1 || s || ((s = r), (r = void 0));
              function e(e) {
                var t = c(e.currentTarget),
                  i = c.extend(
                    { $source: n, $currentTarget: t },
                    a.readElementConfig(n[0], d.namespace),
                    a.readElementConfig(e.currentTarget, d.namespace),
                    s
                  ),
              ...
              var l,
                ...
                d = c.extend({}, a.defaults, a.readElementConfig(n[0], t), s);
              return (
                n.on(d.openTrigger + "." + d.namespace, d.filter, e),
                { filter: d.filter, handler: e }
              );
            },
            current: function () {
              var e = this.opened();
                  ...
                  c(document).on("click", o.autoBind, function (e) {
                    if (!e.isDefaultPrevented()) {
                      ...
                      if (n.length !== (n = n.add(t)).length) {
                        var i = o.attach(t);
                        (!i.filter || 0 < c(e.target).parentsUntil(t, i.filter).length) &&
                          i.handler(e);
                      }
                    }
                  });
            ...
            _callbackChain: {
              ...
              afterContent: function (e, t) {
                var i = e(t);
                return (
                  this.$instance.find("[autofocus]:not([disabled])").focus(), this.onResize(t), i
                );
              },
            },
          }),
    ...
    function l(e, t) {
      ...
      (this.id = l.id++), this.setup(e, t), this.chainCallbacks(l._callbackChain);
    }
  })(jQuery),
  (function (E) {
    "use strict";
    ...
    function P(e, t) {
      H()
        ? e.addEventListener(
            "touchstart",
            function (e) {
              e.cancelable && e.preventDefault(), t(e);
            },
            { passive: !0 }
          )
        : (e.addEventListener("mousedown", function (e) {
          ...
          e.addEventListener("keydown", function (e) {
            (32 !== e.keyCode && 13 !== e.keyCode) || A || ((A = !0), t(e));
          }));
    }
    (E.fn.val = function (e) {
      return (
        1 <= arguments.length &&
          void 0 !== this[0] &&
          this[0]["bootstrap-input-spinner"] &&
          this[0].setValue &&
          this[0].setValue(e),
        t.apply(this, arguments)
      );
    }),
      (E.fn.InputSpinner = E.fn.inputSpinner =
        function (e) {
          if (
            "1" === jupiterxOptions.quantityFieldSwitch ||
            "undefined" === jupiterxOptions.quantityFieldSwitch
          ) {
            var $ = {
            ...
            var j =
                ...
                $.groupClass +
                '"><div class="input-group-prepend"><button style="min-width: ' +
                $.buttonsWidth +
                '" class="btn btn-decrement ' +
                $.buttonsClass +
                '" type="button">' +
                $.decrementButton +
                '</button></div><input type="text" style="text-align: ' +
                $.textAlign +
                '" class="form-control"/><div class="input-group-append"><button style="min-width: ' +
                $.buttonsWidth +
            ...
            this.each(function () {
              var o = E(this);
              (o[0]["bootstrap-input-spinner"] = !0), o.hide();
              var t = null,
                i = null,
                ...
                p =
                  isNaN(o.prop("max")) || "" === o.prop("max") ? 1 / 0 : parseFloat(o.prop("max")),
              ...
              if (v) {
                var y = E('<span class="input-group-text">' + v + "</span>");
                s.find(".input-group-prepend").append(y);
              }
              if (w) {
                var b = E('<span class="input-group-text">' + w + "</span>");
              ...
              function k(e, t) {
                void 0 === t && (t = !0),
                  (g =
                    isNaN(e) || "" === e
                      ? ((o[0].value = ""), t && (d[0].value = ""), NaN)
                      : ((e = parseFloat(e)),
                        (c = parseFloat(o.prop("min")) || 0),
                        (p =
                          isNaN(o.prop("max")) || "" === o.prop("max")
                            ? 1 / 0
              ...
              function C(e) {
                isNaN(g) && (g = 0), k(Math.round(g / e) * e + e), x(o, "input"), x(o, "change");
              }
              function S() {
                (m = 0), (r = r = n ? 1 : $.boostMultiplier), clearTimeout(t), clearTimeout(i);
              }
              function _() {
              ...
              (o[0].setValue = function (e) {
                ...
                (function (e, t) {
                  if (H())
                    return e.addEventListener("touchend", function (e) {
                      t(e);
                    });
                  e.addEventListener("mouseup", function (e) {
                    ...
                    e.addEventListener("keyup", function (e) {
                      (32 !== e.keyCode && 13 !== e.keyCode) || ((A = !1), t(e));
                    });
  ...
  $(document).on("wc_fragments_refreshed wc_fragments_loaded", function () {
    ...
    0 < e.parents(".elementor-widget-raven-shopping-cart").length ||
      ($.each(e, function () {
        $(this).find("a").eq(0).addClass("jupiterx-icon-shopping-cart-6");
      }),
      $(document)
        .find(".woocommerce-mini-cart-item .remove")
        .addClass("jupiterx-icon-solid-times-circle")
        .html(" "),
      $(document)
        .find(".woocommerce-mini-cart__empty-message")
  ...
  jQuery(document).ready(function (t) {
    ...
    0 ===
      t(
        '.elementor[ data-elementor-type="jet-woo-builder" ], .elementor[ data-elementor-type="product" ]'
      ).length &&
      (e(),
      ...
      t(document).on("click", ".jupiterx-navbar-cart", function (e) {
        "#" === t(this).attr("href") &&
          (e.preventDefault(), t("body").addClass("jupiterx-cart-quick-view-overlay"));
      }),
  ...
  jQuery(document).ready(function (d) {
    function i() {
      return "undefined" == typeof jupiterxOptions || void 0 === jupiterxOptions.videMedia
        ? null
        : 0 != jupiterxOptions.videMedia;
    }
    function l() {
    ...
    function c(e) {
      (this.$target = e),
        ...
        this.$target.hasClass("jupiterx-product-gallery-static")
          ? this.initZoom()
    ...
    if (
      ((c.prototype.handleVideoWithoutSlider = function () {
        var a = this.$target;
        a.ready(function () {
          var e = a.find("video"),
            t = a.find("iframe"),
          ...
          0 < e.length &&
            ...
            0 < i.length &&
              0 < i.find("video").length &&
              void 0 !== i.find("video").attr("autoplay") &&
              (i
                .find("video")
                .parent()
                .find("i")
          ...
          a.on("click", ".jupiterx-attachment-media-custom-video-icons", function (e) {
            var t = d(e.currentTarget),
              ...
              r = a.find("video"),
              s = a.find("iframe");
            if ((0 < s.length && c.prototype.resetIframes(s), !o.get(0).paused))
              return i.removeClass("circle-pause").addClass("circle-play"), void o.get(0).pause();
        ...
        d(".pswp__button--close")
          ...
          d(".pswp__item")
            ...
            .on("click touched", function (e) {
              d(e.target).closest("img.pswp__img").length ||
                d(e.target).closest(".pswp--open").removeClass("pswp--open");
            });
      }),
      ...
      (c.prototype.handlePhotoswipeIcon = function () {
        ...
        e.ready(function () {
          (ifram = e.find(".jupiterx-attachment-media-iframe")),
            o.initZoom(),
            0 < ifram.length
              ? t.find(".woocommerce-product-gallery__trigger").hide(0)
              : t.find(".woocommerce-product-gallery__trigger").show(0);
        }),
          void 0 !== i &&
            (i.vars.after = function () {
      ...
      (c.prototype.handleVideoOnChangeSlide = function () {
        ...
        o.on(
          "click",
          ".flex-direction-nav a, .flex-control-thumbs li, .woocommerce-product-gallery__image a, .woocommerce-product-gallery__trigger",
          function () {
            var e = o.find("video"),
              t = o.find("iframe"),
          ...
          0 < e.length &&
            e.each(function (e, t) {
              ...
              if (0 < i.length) {
                ...
                l.push({
                  html: '<div class="jupiterx-pswp-attachment-media-iframe">' + a + "</div>",
                });
              }
            }),
          l
      ...
      (c.prototype.handleVideoOnPhotoSwipe = function (n, e) {
        d(n).hasClass("pswp--open") &&
          e.listen("beforeChange", function () {
            var i = d(n).find("video"),
              e = d(n).find("iframe"),
              t = d(n).find(".pswp__item");
            0 < i.length &&
              (i.parent().find("i").removeClass("circle-pause").addClass("circle-play"),
              i.get(0).pause());
            if (0 < e.length) {
              var o = e.attr("src");
              (e = e.attr("src", o)),
            ...
            t.each(function (e, t) {
              if ("block" === d(t).css("display") && void 0 !== d(t).find("video").attr("autoplay"))
                return (
                  i.parent().find("i").removeClass("circle-play").addClass("circle-pause"),
      ...
      (c.prototype.openPhotoswipe = function (e) {
        if (wc_single_product_params.photoswipe_enabled) {
          ...
          var t,
            i = d(".pswp")[0],
            o = c.prototype.getGalleryItems(),
            n = d(e.target);
          t =
            n.is(".woocommerce-product-gallery__trigger") ||
            n.is(".woocommerce-product-gallery__trigger img")
              ? d(".flex-active-slide")
              : n.closest(".woocommerce-product-gallery__image");
          var r = d.extend(
              {
                index: d(t).index(),
          ...
          s.init(), c.prototype.handleVideoOnPhotoSwipe(i, s);
        }
      }),
      ...
      (c.prototype.handleVideoWithoutGallery = function () {
        var e = this.$target;
        0 === e.find(".flex-viewport").length &&
          e.on("click", ".jupiterx-attachment-media-custom-video-icons", function (e) {
            var t = d(e.currentTarget),
              i = d(e.currentTarget).find("i"),
              o = t.prev();
            if (!o.get(0).paused)
              return i.removeClass("circle-pause").addClass("circle-play"), void o.get(0).pause();
            i.removeClass("circle-play").addClass("circle-pause"), o.get(0).play();
          });
      }),
      (c.prototype.handleVideo = function () {
        d(document).on("click", ".jupiterx-attachment-media-custom-video-icons", function (e) {
          var t = d(e.currentTarget),
            i = d(e.currentTarget).find("i"),
            o = t.prev(),
          ...
          if (
            ((d("body").hasClass("jupiterx-product-template-9") ||
              d("body").hasClass("jupiterx-product-template-10")) &&
              (n = !0),
            n || r)
          ) {
            if (!o.get(0).paused)
      ...
      (c.prototype.createSlickThumbnailsSlider = function () {
        ...
        e.hasClass("jupiterx-product-gallery-vertical") &&
          (t = d.extend(t, { vertical: !0, slidesToShow: 5 })),
          e.find(".flex-control-thumbs").slick(t),
          i() &&
            ((galleryItems = e.find(".woocommerce-product-gallery__image")),
            galleryItems.each(function (e, t) {
              void 0 !== d(t).data("poster") &&
                d(".flex-control-nav")
      ...
      (c.prototype.repositionDirectionNav = function () {
        var e,
          i = this.$target;
        i.hasClass("jupiterx-product-gallery-vertical") &&
          ((e = function () {
        ...
        if (d.isFunction(d.fn.zoom) || wc_single_product_params.zoom_enabled) {
          ...
          if (
            (d(t).each(function (e, t) {
              if (d(t).find("img").data("large_image_width") > i) return !(o = !0);
            }),
            o)
          ) {
            var n = { touch: !1 };
            "ontouchstart" in window && (n.on = "click"), t.trigger("zoom.destroy"), t.zoom(n);
          }
        }
      }),
      ...
      0 === d('.elementor[ data-elementor-type="jet-woo-builder" ]').length &&
        d(".woocommerce-product-gallery").each(function (e, t) {
          new c(d(t));
        }),
      ...
      var p = new (function e(t) {
        ...
        (this.$variationsForm = t),
          ...
          void 0 === e._initialized &&
            ((e.prototype.bindEvents = function () {
              this.$variationsForm.on(
                "woocommerce_variation_select_change",
                this.onVariationAttributeChange
              ),
                d(".single_variation_wrap").on("show_variation", this.onVariationSelected);
            }),
            (e.prototype.checkOutOfStockStatus = function () {
              this.isProductInStock() || (this.$onSaleBadge.hide(), this.$outOfStockBadge.show());
            }),
            (e.prototype.onVariationAttributeChange = function () {
              0 === (i.$variationsForm.find("input[name=variation_id]").val() || 0) &&
                (i.isProductInStock()
                  ? i.isProductOnSale() && (i.$onSaleBadge.show(), i.$outOfStockBadge.hide())
                  : i.$outOfStockBadge.show());
            }),
            ...
            (e.prototype.toggleOutOfStockBadgeVisibility = function (e) {
              e.is_in_stock
                ? (this.isVariationOnSale(e.variation_id)
                    ? this.$onSaleBadge.show()
            ...
            (e.prototype.isProductOnSale = function () {
              for (var e = 0; e < this.variations.length; e++) {
                ...
                if (t.display_price !== t.display_regular_price) return !0;
              }
              return !1;
            }),
            (e.prototype.isVariationOnSale = function (e) {
              for (var t = 0; t < this.variations.length; t++) {
                ...
                if (i.display_price !== i.display_regular_price && e === i.variation_id) return !0;
              }
              return !1;
            }),
            (e.prototype.isProductInStock = function () {
              for (var e = 0; e < this.variations.length; e++)
                if (this.variations[e].is_in_stock) return !0;
              return !1;
            }),
            (e.prototype.selectOptionControl = function () {
              ...
              d("body").find(e.outOfStockClassName) &&
                d(e.selected).change(function () {
                  "" == d(e.selected).children("option:selected").val() &&
                    d(e.outOfStockClass).css("display", "none");
                });
            }),
                ...
                this.$variationsForm.on("woocommerce_update_variation_values", function (e) {
                  ...
                  setTimeout(function () {
                    (price = d(e.currentTarget).find(".woocommerce-variation-price")),
                      0 !== price.length &&
                        "none" !== price.parents(".woocommerce-variation").css("display") &&
                        ("" === (t = d(e.currentTarget).attr("current-image")) &&
                          ((i = s.content),
                          (o = s.video_type),
                          (n = s.poster),
                          p.handleNavControl(s.enabled)),
                        a.forEach(function (e) {
                          e.image_id === parseInt(t) &&
                            ((i = e.jupiterx_attached_media),
                            (o = e.jupiterx_attached_media_type),
                            (n = e.jupiterx_attached_media_poster),
                            p.handleNavControl(e.jupiterx_attached_media_enabled));
                        }),
                        i && i.includes("jupiterx-attachment-media-iframe")
                          ? d(".woocommerce-product-gallery__trigger").hide(0)
                          : d(".woocommerce-product-gallery__trigger").show(0),
                        r.html(i),
            ...
            (e.prototype.handleNavControl = function (e) {
              ...
              e
                ? 0 === i.length && t.prepend('<i class="jupiterx-product-single-play-icon"></i>')
                : i.remove();
            }),
            (e._initialized = !0));
    ...
    d("body").find(".woocommerce-product-gallery__trigger") &&
      d(".pswp__button--close").attr("ontouchstart", "return false;"),
      d("body").find(".woocommerce-product-rating") &&
        "jet-woo-builder" != d("main .elementor").data("elementor-type") &&
        (d(".woocommerce-review-link").attr("href", "#jupiterx-wc-header-reviews"),
        d("#tab-title-reviews").attr("id", "jupiterx-wc-header-reviews"),
        "#jupiterx-wc-header-reviews" === window.location.hash &&
          (d(".wc-tabs").children("li").removeClass("active"),
        ...
        jQuery(".woocommerce-product-rating > a").click(function (e) {
          (d = jQuery), e.preventDefault(), e.stopPropagation();
          var t = d(".woocommerce-review-link").attr("href");
          if (
            ("#jupiterx-wc-header-reviews" === t &&
              (d(".wc-tabs").children("li").removeClass("active"),
              d("#jupiterx-wc-header-reviews").addClass("active"),
              d("#jupiterx-wc-header-reviews a").trigger("click"),
            ...
            !(
              (window.jupiterx.utils.onMobile() &&
                d("body").hasClass("jupiterx-header-mobile-behavior-off")) ||
              (window.jupiterx.utils.onTablet() &&
                d("body").hasClass("jupiterx-header-tablet-behavior-off"))
            ))
          ) {
            var i = d(t);
            if (0 !== i.length) {
              ...
              (n -= o ? 2 * d(".jupiterx-header").height() : d(".jupiterx-header").height() + 50),
                !1 !== is_smooth_scroll()
                  ? d("html, body").stop().animate({ scrollTop: n }, 500, "swing")
                  : d("html, body").stop().animate({ scrollTop: n }, 0);
            }
          }
        })),
      0 < d(".elementor-jet-single-images").length &&
        (d(".elementor-jet-single-images")
          .find(".woocommerce-product-gallery")
          .addClass("jupiterx-jet-woo-gallery"),
        d(".elementor-jet-single-images")
          .find(".flex-active")
          .addClass("jupiterx-jet-woo-gallery-active-item"),
        d(".elementor-jet-single-images")
          .find(".flex-control-thumbs img")
          .on("click", function (e) {
            d(".elementor-jet-single-images")
              .find(".flex-active")
              .removeClass("jupiterx-jet-woo-gallery-active-item"),
      ...
      window.elementorFrontend &&
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/widget", function (e) {
          "jet-single-images.default" === e.data("widget_type") &&
            (e.find(".woocommerce-product-gallery").addClass("jupiterx-jet-woo-gallery"),
      ...
      (this.$productContainer = o(".jupiterx-product-container")),
        ...
        void 0 === e._initialized &&
          ...
          (e.prototype.showQuickView = function (e) {
            i.modals[e]
              ? i.modals[e].open()
              : (i.modals[e] = o.featherlight(o("#jupiterx-product-quick-view-modal-" + e), {
                  persist: !0,
  ...
  jQuery(document).ready(function (o) {
    function e() {
      o(".entry-summary").css({ top: 50 });
    }
    (o.scrollDetection = function (e) {
      var t = o.extend({ scrollDown: function () {}, scrollUp: function () {} }, e),
        i = 0;
      o(window).scroll(function () {
        var e = o(this).scrollTop();
        i < e ? t.scrollDown() : e < i && t.scrollUp(), (i = e);
      });
    }),
      0 !== o(".jupiterx-product-sticky-info").length &&
        (e(),
        o.scrollDetection({
          scrollUp: function () {
            e();
          ...
          scrollDown: function () {
            !(function () {
              var e = 50,
                ...
                i = o(window).height();
              i < t && (e = i - t), o(".entry-summary").css({ top: e });
            })();
          },
        }));
  }),
