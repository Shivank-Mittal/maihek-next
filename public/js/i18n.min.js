...
(() => {
                ...
                if ("string" == typeof t[n]) g += t[n];
                  ...
                  i.json.test(s.type)
                    ...
                    : (!i.number.test(s.type) || (c && !s.sign)
                        ? (f = "")
                        : ((f = c ? "+" : "-"), (r = r.toString().replace(i.sign, ""))),
  ...
  (() => {
    ...
    function d(t, e) {
      var r;
      for (r in ((this.data = t), (this.pluralForms = {}), (this.options = {}), f))
    ...
    (d.prototype.getPluralForm = function (t, e) {
      ...
      return (
        a ||
          ("function" !=
            typeof (i =
              (r = this.data[t][""])["Plural-Forms"] || r["plural-forms"] || r.plural_forms) &&
            ((n = (function (t) {
              var e, r, n;
      ...
      (d.prototype.dcnpgettext = function (t, e, r, n, i) {
        ...
        return (
          ...
          (s = this.data[t][o]) && s[a]
            ? s[a]
            : (this.options.onMissingKey && this.options.onMissingKey(r, t), 0 === a ? r : n)
        );
      });
      ...
      x = (t, e, r) => {
        ...
        return {
          ...
          addLocaleData: (t, e = "default") => {
            (n.data[e] = { ...n.data[e], ...t, "": { ...h, ...n.data[e]?.[""], ...t?.[""] } }),
              delete n.pluralForms[e],
              a();
          },
          resetLocaleData: (t, e) => {
          ...
          _nx: (t, e, n, i, a) => {
            let o = l(a, i, t, e, n);
            return r
              ? ((o = r.applyFilters("i18n.ngettext_with_context", o, t, e, n, i, a)),
                r.applyFilters("i18n.ngettext_with_context_" + u(a), o, t, e, n, i, a))
              : o;
          },
