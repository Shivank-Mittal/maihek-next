  ...
  var o = function (o, s) {
    ...
    var h = function () {
      ...
      k = function () {
        ...
        const t = { position: "fixed", width: r, marginTop: 0, marginBottom: 0 };
        (t[e.to] = e.offset),
      ...
      T = function () {
        ...
        if (a) {
          ...
          var n = w(i);
          (t = "top" === e.to ? n.top.fromTop - o : -n.bottom.fromBottom - o) <= 0 &&
            (u(), h(), k(), (a = !0), i.trigger("sticky:stick"), e.parent && $());
        }
        !(function (t) {
          f && -t < e.effectsOffset
            ? (i.removeClass(e.classes.stickyEffects), (f = !1))
            : !f && -t >= e.effectsOffset && (i.addClass(e.classes.stickyEffects), (f = !0));
        })(t);
      },
      B = function () {
        T();
