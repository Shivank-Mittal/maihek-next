              ...
              pack: {
                ...
                promo: function (e) {
                  return (
                    i.aliases.promo +
                    "=" +
                    a.setLeadingZeroToInt(a.randomInt(e.min, e.max), e.max.toString().length)
                  );
                },
              },
            };
      ...
      3: [
        function (e, t, r) {
          ...
          t.exports = {
            ...
            get: function (e) {
              for (
                var t = this.encodeData(e) + "=", r = document.cookie.split(";"), n = 0;
                n < r.length;
                n++
              ) {
      ...
      4: [
        function (e, t, r) {
          ...
          t.exports = {
            ...
            getParam: function (e) {
              for (
                var t = {}, r = (e || window.location.search.substring(1)).split("&"), n = 0;
                n < r.length;
                n++
              ) {
                var a = r[n].split("=");
                          ...
                          : (function () {
                              ...
                              if (
                                !(
                                  e &&
                                  s.parse(e).host &&
                                  s.parse(e).host.match(/^(?:.*\.)?yandex\..{2,9}$/i)
                                )
                              )
                                return !1;
                              try {
                      ...
                      for (var i = 0; i < x.organics.length; i++) {
                        if (
                          ...
                          s
                            .parse(e)
                            .query.match(
                              new RegExp(".*" + o.escapeRegexp(x.organics[i].param) + "=.*", "i")
                            )
                        )
                          return (r = x.organics[i].display || x.organics[i].host), !0;
            ...
            function D() {
              i.set(n.containers.current_extra, n.pack.extra(x.timezone_offset), I, w, q),
                i.get(n.containers.first_extra) ||
                  i.set(n.containers.first_extra, n.pack.extra(x.timezone_offset), I, w, q);
            }
            return (
              ...
              i.get(n.containers.session)
                ? ((b =
                    parseInt(
                      i.parse(n.containers.session)[i.unsbjs(n.containers.session)][
              ...
              x.promocode &&
                ...
                i.set(n.containers.promocode, n.pack.promo(x.promocode), I, w, q),
                ...
                go: function (e, t) {
                  ...
                  try {
                    ...
                    a.get(n.containers.session) &&
                      a.set(n.containers.session, n.pack.session(0), t.l, t.d, t.i),
              ...
              if (
                ...
                t.domain && this.validate.isString(t.domain)
                  ...
                  : t.domain && t.domain.host
                    ? (r.domain = t.domain)
                    : (r.domain = { host: a.getHost(document.location.hostname), isolate: !1 }),
                (r.referrals = []),
