 ...
 * Copyright Vasil Dinkov, Vadikom Web Ltd. http://vadikom.com; Licensed MIT */ !(function (a) {
      ...
      prototype: {
        init: function (c) {
          ...
          if (!c) {
            ...
            this.$root
              ...
              a(window).on(d({ "resize orientationchange": a.proxy(this.winResize, this) }, g)),
            ...
            this.$root.find("a:not(.mega-menu a)").each(function () {
              ...
              (b != j && b != k) ||
                ...
                f.opts.markCurrentTree &&
                  c.parentsUntil("[data-smartmenus-id]", "ul").each(function () {
              ...
              b.dataSM("scroll-arrows") && b.dataSM("scroll-arrows").remove(),
                b.dataSM("shown-before") &&
                  ((d.opts.subMenusMinWidth || d.opts.subMenusMaxWidth) &&
                    b.css({ width: "", minWidth: "", maxWidth: "" }).removeClass("sm-nowrap"),
                  b.dataSM("scroll-arrows") && b.dataSM("scroll-arrows").remove(),
                  b.css({
                    zIndex: "",
                    top: "",
        ...
        disable: function (b) {
          if (!this.disabled) {
            if ((this.menuHideAll(), !b && !this.opts.isPopup && this.$root.is(":visible"))) {
              ...
              this.$disableOverlay = a('<div class="sm-jquery-disable-overlay"/>')
                .css({
                  position: "absolute",
                  top: c.top,
                  left: c.left,
        ...
        docClick: function (b) {
          return this.$touchScrollingSub
            ...
            : void (
                ((this.visibleSubMenus.length && !a.contains(this.$root[0], b.target)) ||
        ...
        docTouchEnd: function (b) {
          if (this.lastTouch) {
            if (
              ...
              (!this.lastTouch.target || !a.contains(this.$root[0], this.lastTouch.target))
            ) {
        ...
        getOffset: function (a, b) {
          var c;
          "none" == a.css("display") &&
            ((c = { position: a[0].style.position, visibility: a[0].style.visibility }),
          ...
          return (
            e || 0 === e || (e = b ? a[0].offsetHeight : a[0].offsetWidth), c && a.hide().css(c), e
          );
        },
          ...
          if (
            ((this.isCollapsible() && !c) ||
              this.menuHideSubMenus(
                this.activatedItems[e - 1] && this.activatedItems[e - 1][0] == b[0] ? e : e - 1
              ),
            ...
            if (d) {
              ...
              if (d.is(":visible")) {
                if (!g && this.opts.showOnClick && e)
                  return (
                    this.menuHide(d), (this.clickActivated = !1), (this.focusActivated = !1), !1
                  );
          ...
          this.handleItemEvents(c) &&
            (!this.focusActivated ||
              ...
              (this.activatedItems.length &&
                this.activatedItems[this.activatedItems.length - 1][0] == c[0]) ||
        ...
        menuInit: function (a) {
          if (!a.dataSM("in-mega")) {
            ...
            for (var b = 2, c = a[0]; (c = c.parentNode.parentNode) != this.$root[0]; ) b++;
        ...
        menuPosition: function (b) {
          ...
          if (
            (w
              ? ((c = x ? p - k - y : y), (e = this.opts.bottomToTopSubMenus ? -l - z : q + z))
              : ((c = x ? y - k : p - y), (e = this.opts.bottomToTopSubMenus ? q - z - l : z)),
            ...
            if (
              ...
              w ||
                (l < v && B + l > t + v ? (e += t + v - l - B) : (l >= v || B < t) && (e += t - B)),
              ...
              b.dataSM("scroll-arrows") ||
                b.dataSM(
                  "scroll-arrows",
                  a([
                    a('<span class="scroll-up"><span class="scroll-up-arrow"></span></span>')[0],
                    a(
              ...
              if (
                ...
                (E[
                  ...
                  b.css({ "touch-action": "none", "-ms-touch-action": "none" }).on(d(E, D));
              }
            }
          }
        ...
        menuScroll: function (a, b, c) {
          ...
          if (
            ...
            this.opts.scrollAccelerate && e.step < this.opts.scrollStep && (e.step += 0.2);
            var k = this;
        ...
        menuScrollMousewheel: function (a, b) {
          if (this.getClosestMenu(b.target) == a[0]) {
            ...
            a
              .dataSM("scroll-arrows")
              .eq(c ? 0 : 1)
              .is(":visible") && ((a.dataSM("scroll").up = c), this.menuScroll(a, !0));
          }
          b.preventDefault();
        },
        ...
        menuScrollRefreshData: function (b) {
          ...
          this.cssTransforms3d && (d = -(parseFloat(b.css("margin-top")) - d)),
            a.extend(c, { upEnd: d, downEnd: d + this.getViewportHeight() - c.subH });
        },
        menuScrollStop: function (a) {
          if (this.scrollTimeout)
            return (
              j(this.scrollTimeout), (this.scrollTimeout = 0), (a.dataSM("scroll").step = 1), !0
            );
        },
            ...
            if (this.getClosestMenu(e.target) == b[0]) {
              ...
              if (/(start|down)$/i.test(d.type))
                this.menuScrollStop(b)
                  ...
                  : (this.$touchScrollingSub = null),
                  this.menuScrollRefreshData(b),
                  a.extend(f, { touchStartY: e.pageY, touchStartTime: d.timeStamp });
                ...
                void 0 !== f.touchY &&
                  ((f.momentum =
                    15 *
                    Math.pow(
                      Math.abs(e.pageY - f.touchStartY) / (d.timeStamp - f.touchStartTime),
                      2
                    )) && (this.menuScrollStop(b), this.menuScroll(b), d.preventDefault()),
                  delete f.touchY);
            }
          }
        },
        menuShow: function (a) {
          if (
            (a.dataSM("beforefirstshowfired") ||
              ...
              this.$root.triggerHandler("beforefirstshow.smapi", a[0]) !== !1)) &&
            this.$root.triggerHandler("beforeshow.smapi", a[0]) !== !1 &&
            (a.dataSM("shown-before", !0), k && a.stop(!0, !0), !a.is(":visible"))
          ) {
            var b = a.dataSM("parent-a"),
              c = this.isCollapsible();
            if (((this.opts.keepHighlighted || c) && b.addClass("highlighted"), c))
              ...
              if (
                ...
                (this.opts.subMenusMinWidth || this.opts.subMenusMaxWidth) &&
                  (a.css({ width: "auto", minWidth: "", maxWidth: "" }).addClass("sm-nowrap"),
                ...
                a.css("max-width", this.opts.subMenusMaxWidth),
                  d > this.getWidth(a) &&
                    a.removeClass("sm-nowrap").css("width", this.opts.subMenusMaxWidth);
              }
              this.menuPosition(a);
            }
            var e = function () {
            ...
            switch (b.keyCode) {
              ...
              case 32:
                ...
                if (e.is("a") && this.handleItemEvents(e)) {
                  ...
                  d &&
                    !d.is(":visible") &&
                    (this.itemClick({ currentTarget: b.target }), b.preventDefault());
                }
            }
        },
        rootOut: function (a) {
