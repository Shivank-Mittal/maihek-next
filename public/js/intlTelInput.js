...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var Iti = class {
      ...
      _setInitialState(overrideAutoCountry = false) {
        ...
        if (dialCode && !isRegionlessNanpNumber) {
          ...
          const isValidInitialCountry =
            lowerInitialCountry && this._getCountryData(lowerInitialCountry, true);
            ...
            if (e.key && e.key.length === 1 && !e.altKey && !e.ctrlKey && !e.metaKey) {
              ...
              if (strictMode) {
                ...
                const hasReachedMaxLength =
                  this.maxCoreNumberLength && coreNumber.length >= this.maxCoreNumberLength;
                const selectedText = this.telInput.value.substring(
      ...
      _updatePlaceholder() {
        const { autoPlaceholder, placeholderNumberType, nationalMode, customPlaceholder } =
          this.options;
