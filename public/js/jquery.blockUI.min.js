  ...
  function e(e) {
        ...
        return (
          ...
          this.each(function () {
            "static" == e.css(this, "position") &&
              ((this.style.position = "relative"), e(this).data("blockUI.static", !0)),
              (this.style.zoom = 1),
              d(this, t);
          })
        );
    ...
    function d(d, c) {
      ...
      if (
        ...
        if (n || S) {
          if (
            (h && c.allowBodyStretch && e.support.boxModel && e("html,body").css("height", "100%"),
    ...
    function a(t, o) {
      ...
      f && (clearTimeout(f), a.removeData("blockUI.timeout")),
        ...
        r(0, t, o),
        null === o.onUnblock &&
          ((o.onUnblock = a.data("blockUI.onUnblock")), a.removeData("blockUI.onUnblock")),
        (i = d
    ...
    function r(t, o, n) {
      ...
      if (
        ...
        (l.data("blockUI.isBlocked", t), i && n.bindEvents && (!t || n.showOverlay))
      ) {
