function focus_populate_live_region() {
  var e = ["woocommerce-message", "woocommerce-error", "wc-block-components-notice-banner"]
      .map(function (e) {
        return "." + e + '[role="alert"]';
      })
      .join(", "),
...
jQuery(function (e) {
  ...
  if ("hidden" === Cookies.get(o)) e(".woocommerce-store-notice").hide();
    ...
    function t(o) {
      ["Enter", " "].includes(o.key) &&
        (o.preventDefault(), e(".woocommerce-store-notice__dismiss-link").click());
    }
    e(".woocommerce-store-notice").show(),
      e(".woocommerce-store-notice__dismiss-link")
        .on("click", function n(i) {
          Cookies.set(o, "hidden", { path: "/" }),
            e(".woocommerce-store-notice").hide(),
            i.preventDefault(),
            e(".woocommerce-store-notice__dismiss-link").off("click", n).off("keydown", t);
        })
        .on("keydown", t);
  }
  e(".woocommerce-input-wrapper span.description").length &&
    ...
    e(".woocommerce-input-wrapper :input")
      ...
      .on("click focus", function () {
        ...
        o.addClass("currentTarget"),
          e(".woocommerce-input-wrapper:not(.currentTarget) span.description:visible")
            .prop("aria-hidden", !0)
            .slideUp(250),
      ...
      o.preventDefault(),
        e(this).hasClass("display-password")
          ? (e(this).removeClass("display-password"),
            e(this).attr("aria-label", woocommerce_params.i18n_password_show))
    ...
    e(document.body).on("item_removed_from_classic_cart", focus_populate_live_region);
}),
