  ...
  [941],
  {
    ...
    9603: (e, t, r) => {
      ...
      class CarouselHandlerBase extends i.default {
            ...
            .forEach((t) => {
              ...
              (s.breakpoints[n[t].value] = {
                ...
                e.image_spacing_custom &&
                  (s.breakpoints[n[t].value].spaceBetween = this.getSpaceBetween(t)),
          ...
          return (
            ...
            c &&
              (s.pagination = {
                ...
                clickable: !0,
                renderBullet: (e, t) =>
                  `<span class="${t}" role="button" tabindex="0" data-bullet-index="${e}" aria-label="${elementorFrontend.config.i18n.a11yCarouselPaginationBulletMessage} ${e + 1}"></span>`,
              }),
        ...
        applyOffsetSettings(e, t, r) {
          ...
          if (
            !(elementorFrontend.isEditMode() && "NestedCarousel" === this.constructor.name) &&
            n &&
            "none" !== n
          )
            switch (n) {
          ...
          this.elements.$swiperContainer
            ...
            .each((r, n) => {
              0 <= n.offsetLeft + e && t > n.offsetLeft + e
                ...
                : (n.setAttribute("aria-hidden", !0), n.setAttribute("inert", ""));
            });
        }
        ...
        handleKenBurns() {
          ...
          this.$activeImageBg && this.$activeImageBg.removeClass(e.classes.kenBurnsActive),
            ...
            this.swiper
              ...
              : (this.$activeImageBg = jQuery(this.elements.$slides[0]).children(
                  "." + e.classes.slideBackground
                )),
      ...
      r(5724),
        ...
        (e.exports = elementorModules.ViewModule.extend({
            ...
            if (
              ...
              "global" !== t && (r += ":" + t),
                e.editorListeners.push({
                  ...
                  callback(t, r) {
                    e.getUniqueHandlerID(r.model.cid, r.$el) === e.getUniqueHandlerID() &&
          ...
          getEditSettings(e) {
            ...
            return (
              this.isEdit &&
                (t = elementorFrontend.config.elements.editSettings[this.getModelCID()].attributes),
              this.getItems(t, e)
            );
          },
    ...
    8140: (e, t, r) => {
      ...
      class StretchedElement extends i.default {
        ...
        isStretchSettingEnabled() {
          return (
            this.getElementSettings(this.getStretchSettingName()) === this.getStretchActiveValue()
          );
        }
        stretch() {
    ...
    7955: (e) => {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        stretch() {
          ...
          s || (elementorFrontend.config.is_rtl && (o = n - (r.outerWidth() + o)), (o = -o)),
            e.margin && (o += e.margin);
          var l = {};
          let u = n;
    ...
    2946: (e, t, r) => {
      ...
      class ArgsObject extends i.default {
        ...
        requireArgumentInstance(e, t) {
          let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.args;
          if ((this.requireArgument(e, r), !(r[e] instanceof t || (0, s.default)(r[e], t))))
    ...
    1851: (e, t, r) => {
      ...
      var n,
        ...
        g = !1;
      [].keys &&
        ("next" in (s = [].keys()) ? (i = u(u(s))) !== Object.prototype && (n = i) : (g = !0)),
        !c(n) ||
        o(function () {
          var e = {};
          return n[f].call(e) !== e;
      ...
      var n = r(4762),
        ...
        b = (e.exports = function (e, t, r) {
          "Symbol(" === g(h(t), 0, 7) && (t = "[" + m(h(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
            ...
            y && r && o(r, "arity") && e.length !== r.arity && f(e, "length", { value: r.arity });
          try {
    ...
    3617: (e, t, r) => {
      ...
      p(f, w) || defineIteratorPrototypeAccessor(w, y),
        (!x && p(f, v) && f[v] !== Object) || defineIteratorPrototypeAccessor(v, E),
        (E.prototype = f),
